...
export default function Chatwindow() {
  ...
  return (
        <div className='flex flex-col justify-center items-center min-h-screen bg-gray-600'>
            <div className='flex flex-col w-full max-w-4xl p-3 rounded-lg flex-1 bg-gray-700'>
                ...
                <div className='flex flex-col flex-1 items-center p-2 mt-5 overflow-y-auto'>
                    <ChatMessage message="Hello, I'm Babs!"/>
